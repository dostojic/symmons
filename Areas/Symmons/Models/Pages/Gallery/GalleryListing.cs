...
namespace symmons.com.Areas.Symmons.Models.Pages.Gallery
{
    // **************************************************************************************************************

    [SitecoreType(TemplateId = "{4E9C2C1D-E08C-4E89-9384-8999827CEC91}", AutoMap = true)]
    public class GalleryListing : ISymmonsBasePage
    {
